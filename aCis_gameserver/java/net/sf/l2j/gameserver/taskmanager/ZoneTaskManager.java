...
public final class ZoneTaskManager implements Runnable
{
	...
	private final void teleport(Player player)
	{
		...
		player.teleToLocation(getCurrentZone().getRandomLoc());
	}
	
	public void onEnter(Player player)
	{
		if (currentZoneId > 0)
			player.sendPacket(new CreatureSay(0, Say2.HERO_VOICE, "RandomZone", "Current zone: " + getCurrentZone().getZoneName()));
	}
