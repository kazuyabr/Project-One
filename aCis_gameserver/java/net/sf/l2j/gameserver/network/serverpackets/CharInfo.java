...
public class CharInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD((_player.getTeam() == TeamType.BLUE ? Integer.decode("0xDF0101") : _player.getTeam() == TeamType.RED ? Integer.decode("0x0000FF") : _player.isAio() ? Config.AIO_COLOR : _player.isVip() ? Config.VIP_COLOR : _player.getClient().isDetached() ? Config.OFFLINE_NAME_COLOR : _player.getAppearance().getNameColor()));
		writeD(_player.getHeading());
		writeD(_player.getPledgeClass());
		writeD(_player.getPledgeType());
		writeD((_player.getTeam() == TeamType.BLUE ? Integer.decode("0xDF0101") : _player.getTeam() == TeamType.RED ? Integer.decode("0x0000FF") : _player.isAio() ? Config.AIO_COLOR : _player.isVip() ? Config.VIP_COLOR : _player.getAppearance().getTitleColor()));
