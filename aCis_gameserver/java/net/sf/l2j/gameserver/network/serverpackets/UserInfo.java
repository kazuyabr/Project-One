...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_player.getTeam() == TeamType.BLUE ? Integer.decode("0xDF0101") : _player.getTeam() == TeamType.RED ? Integer.decode("0x0000FF") : _player.isAio() ? Config.AIO_COLOR : _player.isVip() ? Config.VIP_COLOR : _player.getAppearance().getNameColor());
