...
public class Frintezza extends L2AttackableAIScript
{
    ...
    public String onAdvEvent(String event, Npc npc, Player player)
    {
        if (event.equalsIgnoreCase("beginning"))
        {
            ...
            ZONE.broadcastPacket(new CreatureSay(0, 1, "Hall Alarm Device", "Intruders! Sound the alarm!"));
            
            startQuestTimer("notice", 60000, null, null, true);
    ...
    public String onKill(Npc npc, Creature killer)
    {
        ...
        else if (npc.getNpcId() == 18328)
        {
            ...
            {
                ZONE.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "De-activate the alarm."));
                deleteAllMobs();
                room2Spawn(1);
            }
        }
