...
public class GrandBossTeleporters extends Quest
{
	...
	private static final Location[] FRINTEZZA_OUT =
	{
	...
	public String onFirstTalk(Npc npc, Player player)
	{
		...
		switch (npc.getNpcId())
		{
			...
			case 29061:
				player.moveToLocation(150037 + Rnd.get(500), -57720 + Rnd.get(500), -2976, 0);
				break;
			...
			case 32011:
				if (st.hasQuestItems(8073))
				{
					...
					if (status == Frintezza.DORMANT)
					{
						...
						ZoneManager.getInstance().getZoneById(110011, BossZone.class).allowPlayerEntry(player, 30);
						player.teleportTo(Rnd.get(FRINTEZZA_OUT), 50);
					...
					htmltext = "<html><body>You do not have the required item to lift the magic forcefield guarding Frintezza. How are you going to remove it without the scroll?</body></html>";
				break;				
