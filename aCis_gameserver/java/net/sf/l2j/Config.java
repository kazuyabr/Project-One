...
public final class Config
{
	...
	public static int REWARD_COUNT_PLAYERS;
	...
	private static final void loadPlayers()
	{
		...
		ANNOUNCE_TOP = players.getProperty("AnnounceTopKiller", false);
		...
		GRAND_BOSS_DEFEATED_BY_CLAN_MEMBER_MSG = players.getProperty("GrandBossDefeatedByClanMemberMsg", "Raid Boss %grandboss% has been defeated by %player% of clan %clan%.");
		GRAND_BOSS_DEFEATED_BY_PLAYER_MSG = players.getProperty("GrandBossDefeatedByPlayerMsg", "Raid Boss %grandboss% has been defeated by %player%.");
		...
		ANNOUNCE_CASTLE_LORDS = players.getProperty("AnnounceCastleLords", false);
	...
	private static final void loadServer()
	{
		...
		REWARD_COUNT_PLAYERS = server.getProperty("RewardCount", 1);
